    ...
    api.get(`/listings/${route.params.listingId}`).then((res) => {
      if (isFocused) {
        if (res.ok) {
          ...
          console.log("Outloc", res.data.contact.locations);
          console.log(res?.data?.yelp_categories?.length, "tttt", config?.yelp);
        ...
        <View style={{ flex: 1 }}>
          ...
          >
            ...
            >
                  ...
                  <View style={styles.priceWrap}>
                    ...
                    >
                      ...
                      {listingData?.price_type !== "on_call" && (
                        <Text style={[styles.listingPricenegotiable, rtlText]}>
                          {" "}
              ...
              {admobConfig.admobEnabled && !admobError && (
                <View
                  style={{
                    alignItems: "center",
                    justifyContent: "center",
              ...
              {/* Penorama Section */}
              {listingData?.panorama?.view_url && config?.panorama && !loading && (
                <View>
                  <View
                    style={{
                      alignItems: rtl_support ? "flex-end" : "flex-start",
